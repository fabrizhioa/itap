      ...
      <div className="flex flex-wrap gap-2">
        <div className="max-w-[256px] relative group">
          <div  className="opacity-0 group-hover:opacity-100 absolute w-full h-full bg-tc/20 text-white flex items-center justify-center">
            <a  href="#" className="p-2 border-[1px] rounded-sm hover:bg-slate-50/20">
            Visitar
            </a>
          </div>
          <button
            className="text-tg text-xl absolute top-1 right-1 z-20"
            type="button"
          >
            <FaRegEdit />
          </button>
        ...
        <Link to="create" className="max-w-[256px] w-full flex items-center justify-center aspect-square bg-tc/20 rounded-sm">
